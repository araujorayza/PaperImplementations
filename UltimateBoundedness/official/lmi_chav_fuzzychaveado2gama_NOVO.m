function P = lmi_chav_fuzzychaveado2gama_NOVO (A,alfa,be,xv,gama,lamb)
...
if be==1
% LMI (21)
    Restr = [Restr Ga1212+Qalfa<-lamb*PT];
% LMI (22)
    Restr = [Restr Ga1112+Qalfa<-lamb*PT Ga1121+Qalfa<-lamb*PT];
% LMI (24)
    Restr = [Restr Ga2121-Qalfa<-lamb*PT];
% LMI (25)
    Restr = [Restr Ga2212-Qalfa<-lamb*PT Ga2221-Qalfa<-lamb*PT];    
% LMI (28)
    Restr = [Restr Ga1221+Ga2112<-lamb*PT];
else
% LMI (21)
    Restr = [Restr Ga2121+Qalfa<-lamb*PT];
% LMI (22)
...
% LMI (25)
    Restr = [Restr Ga1112-Qalfa<-lamb*PT Ga1121-Qalfa<-lamb*PT];
% LMI (29)
    Restr = [Restr Ga2112+Ga1221<-lamb*PT];
end
