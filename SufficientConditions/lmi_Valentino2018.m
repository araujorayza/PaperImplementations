function P = lmi_Valentino2018 (A,alfa,xv,be,mu,Ns)
...
a21=(1/Ns)*(P11-L11')+alfa1*(R11*A{1,1});
a22=(1/Ns)*(-R11-R11');
Ga1111=[a11 a21';a21 a22]; % Garfo_{11-11}

a11=alfa2*(L22*A{2,2}+A{2,2}'*L22');
a21=(1/Ns)*(P22-L22')+alfa2*(R22*A{2,2});
a22=(1/Ns)*(-R22-R22');
